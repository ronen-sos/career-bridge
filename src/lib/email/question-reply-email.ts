...
export function buildQuestionReplyEmail(input: QuestionReplyEmailInput) {
  ...
  const subject = `${input.managerName} replied to your question — Career Bridge`;

  const text = [
    `Hi ${input.participantName},`,
    "",
    `${input.managerName} replied to your question in Career Bridge:`,
    "",
          ...
          <tr>
            <td style="padding:32px;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:16px;line-height:1.6;">
              ...
              <p style="margin:0 0 28px;text-align:center;">
                <a href="${messagesUrl}" style="display:inline-block;background:#047857;color:#ffffff;text-decoration:none;font-weight:600;padding:14px 28px;border-radius:12px;font-size:16px;">Read on Career Bridge</a>
              </p>
            </td>
          </tr>
          <tr>
